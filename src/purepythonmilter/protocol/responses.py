...
class BaseHeaderManipulation(AbstractManipulation):
    ...
    @headername.validator  # pyright: ignore PylancereportUnknownMemberType
...
class InsertHeader(BaseHeaderManipulation):
    ...
    @index.validator  # pyright: ignore PylancereportUnknownMemberType
...
class ChangeHeader(BaseHeaderManipulation):
    ...
    @nth_occurrence.validator  # pyright: ignore PylancereportUnknownMemberType
